...
export function ContactSection() {
  return (
    <section id="contact" className="px-6 py-24">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.8fr_1.2fr_0.8fr]">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.32em] text-fuchsia-300">Get in Touch</p>
          ...
          <div className="mt-8 flex gap-3">
            {/* <a className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/8 transition hover:bg-white/15" href="#">
              <Linkedin size={20} />
            </a>
            <a className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/8 transition hover:bg-white/15" href="#">
              <Github size={20} />
            </a> */}
            <a className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/8 transition hover:bg-white/15" href="mailto:cezar.dev@example.com">
              <Mail size={20} />
            </a>
          </div>
        </div>
      ...
      <footer className="mx-auto mt-16 flex max-w-7xl flex-col justify-between gap-4 border-t border-white/8 pt-8 text-sm text-white/45 md:flex-row">
